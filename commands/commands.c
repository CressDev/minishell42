...
/*   Updated: 2026/01/10 18:38:51 by kjroydev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	is_built_in(t_cmd *cmd, t_envs *envs)
{
	...
	if (ft_strcmp(cmd->args[0], "env") == 0)
		return (env_command(*envs->env, cmd->args), true);
	if (ft_strcmp(cmd->args[0], "pwd") == 0)
		return (pwd_command(), true);
	if (ft_strcmp(cmd->args[0], "unset") == 0)
		return (unset_command(envs, cmd->args), true);
	if (ft_strcmp(cmd->args[0], "exit") == 0)
		return (exit_command(cmd->args), true);
	if (ft_strcmp(cmd->args[0], "export") == 0)
		return (export_command(envs->env, cmd), true);
	if (ft_strcmp(cmd->args[0], "echo") == 0)
		return (echo_command(cmd), true);
	if (ft_strcmp(cmd->args[0], "cd") == 0)
		return (cd_command(envs, cmd), true);
	return (false);
}
